      ...
      {data.actor.role === "admin" && (
        <>
          ...
          <section className="mt-6">
            ...
            <p className="mt-4 max-w-[68ch] text-sm leading-relaxed text-muted-foreground">
              Enable a stockable product at a warehouse before Operations records its first
              delivery. Configuring a location creates a zero balance; it never changes stock that
              is already on hand.
            </p>
          </section>
        </>
