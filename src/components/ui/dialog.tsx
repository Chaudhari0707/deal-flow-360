...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "sticky bottom-0 z-10 -mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-b-xl border-t bg-muted/95 p-4 shadow-[0_-8px_12px_-12px_rgb(0_0_0_/_0.35)] backdrop-blur-sm sm:flex-row sm:justify-end",
        className,
      )}
      {...props}
    >
